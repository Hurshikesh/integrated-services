        ...
        <div className="min-h-screen bg-gray-100">
            <main className="container mx-auto px-4 py-8">
                <section className="mb-12">
                    <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-blue-600">Search for Aadhar Offices and Land registration Offices Near You</h2>
                ...
                {showResults && (
                    <div>
                        ...
                        {serviceType === 'Aadhar seva kendra' &&
