    ...
    <div className="min-h-screen">
      <main className="container mx-auto px-4 py-8">
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6 text-center text-blue-600">Search for elder care and nursing home near you</h2>
        ...
        {loading ? (
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 text-center text-blue-600">nursing home Near You</h2>
...
export default FindElderCarePage;