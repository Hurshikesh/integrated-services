    ...
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 py-8">
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6 text-center text-blue-600">Search for Home Repair Services Near You</h2>
          <form onSubmit={handleSearch} className="max-w-lg mx-auto bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div className="mb-4">
              ...
              <select
                ...
                className="border border-gray-300 text-black p-2 md:p-3 rounded-lg w-full"
              >
            ...
            <button type="submit" className="bg-blue-600 text-white p-2 md:p-3 rounded-lg w-full hover:bg-blue-700 transition duration-300">
                ...
                <div className="space-y-8">
                  {sortServices(services, sortOption).map((service) => (
                    <div key={service.id} className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col sm:flex-row">
                      <img
                        src="https://i.postimg.cc/1z188c4S/repair.avif"
