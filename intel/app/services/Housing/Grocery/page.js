    ...
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 py-8">
        <section className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6 text-center text-blue-600">Search for Grocery Stores Near You</h2>
          <form onSubmit={handleSearch} className="max-w-lg mx-auto bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div className="mb-4">
              <label htmlFor="serviceType" className="text-gray-700 font-bold mb-2 block">
                Service Type:
              </label>
              <select
                id="serviceType"
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                <input
                  ...
                  className="border border-gray-300 text-black p-2 rounded-lg flex-grow"
            ...
            <div className="mb-4">
              <label htmlFor="sortOption" className="text-gray-700 font-bold mb-2 block">
                Sort by:
              </label>
              <select
                id="sortOption"
                ...
                {sortServices(services, sortOption).map((service) => (
                  <div key={service.id} className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col sm:flex-row">
                    ...
                    <div className="p-4 sm:p-6 flex-grow">
                      ...
                      {service.distance && (
                        <p className="text-gray-800 mb-2 text-lg sm:text-xl">{`Distance: ${service.distance.toFixed(2)} km`}</p>
                      )}
                      {service.travelTime && (
                      ...
                      {service.contacts && service.contacts[0].www && service.contacts[0].www[0].value ? (
                        <p className="text-gray-800 mb-2 text-lg sm:text-xl break-words">
                        ...
                        <p className="text-gray-800 mb-2 text-lg sm:text-xl">Website not provided</p>
                      )}
                      <button
                        onClick={() => window.open(`https://www.google.com/maps/search/?api=1&query=${service.position.lat},${service.position.lng}`, '_blank')}
                        className="bg-blue-600 text-white p-2 sm:p-3 rounded-lg mt-4 hover:bg-blue-700 transition duration-300 flex items-center justify-center w-full"
                      >
